# This Makefile is for the HTTP::MobileAgent::Plugin::Charset extension to perl.
#
...
#     AUTHOR => q[Tokuhiro Matsuno <tokuhirom aaaatttt gmail dotottto commmmm>]
#     DIR => []
#     DISTNAME => q[HTTP-MobileAgent-Plugin-Charset]
#     NAME => q[HTTP::MobileAgent::Plugin::Charset]
#     NO_META => q[1]
#     PL_FILES => {  }
...
NAME_SYM = HTTP_MobileAgent_Plugin_Charset
VERSION = 0.01
...
FULLEXT = HTTP/MobileAgent/Plugin/Charset
BASEEXT = Charset
PARENT_NAME = HTTP::MobileAgent::Plugin
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTTP/MobileAgent/Plugin/Charset.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/HTTP/MobileAgent/Plugin
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/HTTP/MobileAgent/Plugin
...
TO_INST_PM = lib/HTTP/MobileAgent/Plugin/Charset.pm

PM_TO_BLIB = lib/HTTP/MobileAgent/Plugin/Charset.pm \
...
DISTNAME = HTTP-MobileAgent-Plugin-Charset
DISTVNAME = HTTP-MobileAgent-Plugin-Charset-0.01
...
manifypods : pure_all  \
	lib/HTTP/MobileAgent/Plugin/Charset.pm \
	lib/HTTP/MobileAgent/Plugin/Charset.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/HTTP/MobileAgent/Plugin/Charset.pm $(INST_MAN3DIR)/HTTP::MobileAgent::Plugin::Charset.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Tokuhiro Matsuno &lt;tokuhirom aaaatttt gmail dotottto commmmm&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/HTTP/MobileAgent/Plugin/Charset.pm blib/lib/HTTP/MobileAgent/Plugin/Charset.pm 
